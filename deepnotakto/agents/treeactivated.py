...
class Activated (QTree):
    ...
    def get_name(self):
        self.name = "Q_tree_activated({})".format(unique_classifier())
...
class SigmoidAll (AllActivated):
    def get_name(self):
        self.name = "Q_tree_sigmoid_all({})".format(unique_classifier())
...
class SigmoidHidden (HiddenActivated):
    def get_name(self):
        self.name = "Q_tree_sigmoid_hidden({})".format(unique_classifier())
...
class TanhAll (AllActivated):
    def get_name(self):
        self.name = "Q_tree_tanh_all({})".format(unique_classifier())
...
class TanhHidden (HiddenActivated):
    def get_name(self):
        self.name = "Q_tree_tanh_hidden({})".format(unique_classifier())
...
class ReluHidden (HiddenActivated):
    def get_name(self):
        self.name = "Q_tree_relu_hidden({})".format(unique_classifier())
...
class ReluAll (AllActivated):
    def get_name(self):
        self.name = "Q_tree_relu_all({})".format(unique_classifier())
